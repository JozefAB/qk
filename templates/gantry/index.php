...
?>
<!doctype html>
<html xml:lang="<?php echo $gantry->language; ?>" lang="<?php echo $gantry->language;?>" class="no-js">
<head>
...
<?php endif; ?>	
    <?php
		...
		$gantry->addStyle("templates/gantry/css/user-menu/demo.css");
	    $gantry->addStyle("templates/gantry/css/user-menu/icons.css");
	    $gantry->addStyle("templates/gantry/css/user-menu/normalize.css");
	    $gantry->addStyle("templates/gantry/css/user-menu/style5.css");
	    $gantry->addStyle("templates/gantry/css/font-awesome.css");
		...
		$gantry->addScript('modernizr.custom.js');
		$gantry->addScript('load-transition.js');
		//$gantry->addScript('classie.js');
		$gantry->addScript('sidebarEffects.js');
		//$gantry->addScript('selectFx.js');
		//$gantry->addScript('fullscreenForm.js');

    ?>
 <script>jQuery('html').removeClass('no-js'); jQuery('html').addClass('js');</script>
</head>
<body <?php echo $gantry->displayBodyTag(); ?>>
	...
	<script src="/qikeytwo/templates/gantry/js/borderMenu.js"></script>
	</body>
</html>
<?php
$gantry->finalize();
