...
//print_r($_SERVER["REQUEST_URI"]);
		...
		if (!strpos( $sajax_remote_uri, "?option=com_adagency")) {
			if (strpos( $sajax_remote_uri, "?")) {
	                        $sajax_remote_uri.='&option=com_adagency';
			} else {
	                        $sajax_remote_uri.='?option=com_adagency';
			}
		} 
		return $sajax_remote_uri."&no_html=1&controller=adagencySajax";
	}
