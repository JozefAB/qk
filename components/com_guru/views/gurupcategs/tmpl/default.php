...
//start generate category list view function
...
<!-- category list
------------------------------------------------------------>
<div id="categoryList" class="clearfix com-cont-wrap">
    <!-- title
    ------------------------------------------------------------>
    <h2 class='categ_name_guru page_title'>
        <?php echo JText::_('GURU_PROGRAM_CATEGORIES'); ?>
    </h2>
	<div id="categoryListContent" class="g_sect clearfix">
		<?php
        if($layout == "0"){
            ...
            while(isset($categs_array[$i])){
                $row = "";
                    $row .= '<div class="course_row_guru  g_row clearfix ">';
                $j = 0;
                while($j<$cols){
                    ...
                    elseif(isset($categs_array[$i]) && trim($categs_array[$i]) != ""){
                        $row .= '<div class="course_cell_guru g_cell span'.$span.'">'.$categs_array[$i]."</div>";
                        $j++;
                    }
                    $i++;
                }
