...
global $Itemid;
	...
	?>
            ...
            <div class="g_padding_wrap clearfix">
                ...
                <div class="guru_modal_login_page page_title g_cell span7">
					...
					<h2><?php echo JText::_('GURU_FREE_MEMBERS_LOGIN_FORM');?></h2>
                    ...
                    <div class="no-padding">
                        <div>
                            ...
                            <form name="login" method="post">
                                ...
                                <input type="hidden" name="course_id" value="<?php echo intval(JRequest::getVar("course_id", "")); ?>" />
                    ...
                    <div class="no-padding">
                        <div>
                            ...
                            <form name="register" method="post">
                                ...
                                <div>
                                    <input type="submit" class="btn btn-primary" value="<?php echo JText::_("GURU_MYPROGRAMS_ACTION_CONTINUE");?>" />
                                </div>
                            </form>
                        </div>
                     </div>
	...
	<?php
		...
		JRequest::setVar("task", "logCustomerIn");
		...
		?>
           ...
           <div class="g_row">
		   		...
		   		<div class="g_cell span12">        
            		...
            		<form name="enroll_stud" method="post" action="index.php">      

                		<input type="submit" class="btn btn-warning"  value="<?php echo JText::_("GURU_ENROLL_NOW"); ?>" />

                        <input type="hidden" name="option" value="com_guru" />

                        <input type="hidden" name="controller" value="guruPrograms" />

                        <input type="hidden" name="cid" value="<?php echo intval((JRequest::getVar("course_id", "")));?>" />
