...
<form method="post" name="adminForm" id="adminForm" action="index.php">
    ...
    <input type="button" class="btn btn-success pull-right clearfix" value="<?php echo JText::_("GURU_SAVE_PROGRAM_BTN"); ?>" onclick="editquestion(<?php echo $_GET['qid'].','.$_GET['cid'];?>)">
