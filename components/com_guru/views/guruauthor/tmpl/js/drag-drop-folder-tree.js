...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.imageFolder = 'components/com_guru/views/guruauthor/tmpl/images/';
		...
		*/
		...
		dropDragableNodes:function()
		{
			...
			*/
			...
			if(tmpVar=='false'){
				var url = "http://"+site_host+'/components/com_guru/views/guruauthor/tmpl/saveOrderG.php?' + for_link;
			}
			else{
				var url = "http://"+site_host+'/components/com_guru/views/guruauthor/tmpl/saveOrderS.php?' + for_link;
			}
