...
<div>
    ...
    <h2><?php echo JText::_('GURU_COMMISSIONS_PENDING')." ".">"." ".JText::_('GURU_VIEW_DETAILS'); ?></h2>
    <div class="g_margin_bottom"><?php echo JText::_('GURU_TABLE_SUMMARY')."<br/>".JText::_('GURU_PRICE').":".$sum_price1. "&nbsp;&nbsp;&nbsp;&nbsp;".JText::_('GURU_O_PAID').":".$sum_price_paid1."&nbsp;&nbsp;&nbsp;&nbsp;".JText::_('GURU_AMOUNT_COMM_PENDING')." ".$tot ;?></div>
</div>
<form  id="adminForm" name="adminForm" method="post">
	...
	<input type="hidden" name="task" value="<?php echo JRequest::getVar("task", "authorcommissions_pending");?>" />
