...
<form class="form-vertical g_margin_left" action="index.php" method="post" name="adminForm" id="adminForm" onsubmit="return validateForm();"> 
   
	<h4><?php if ($program->id<1) echo JText::_('GURU_NEWDAY'); else echo JText::_('GURU_EDITDAY');?></h4>
	
    <div class="control-group" id="media-name">
    ...
    <div class="control-group" id="media-name">
        ...
        <div class="controls" id="menu_med_1">
