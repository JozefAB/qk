...
<br /><br />
<div>
    <form name="form1" action="<?php echo JURI::root(); ?>index.php?option=com_guru&controller=guruAuthor&task=addexercise&tmpl=component&cid=<?php echo $_GET['cid'];?>" method="post">
            ...
            <div class="input-group g_search">
             ...
             <div class="btn-group g_margin_left">
                ...
                <select name="media_select" onChange="document.form1.submit()">
                    <option value="all" <?php if ( (!isset($_POST['media_select'])) || (isset($_POST['media_select']) && $_POST['media_select'] == 'all') ) echo ' selected="selected" ';?>><?php echo JText::_("GURU_ALL"); ?></option>
                    <option value="docs" <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'docs') echo ' selected="selected" ';?>><?php echo JText::_("GURU_MEDIATYPEDOCS"); ?></option>
                    <option value="file" <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'file') echo ' selected="selected" ';?>><?php echo JText::_("GURU_FILE"); ?></option>
                </select>
            </div>
      </div>
    </form>
            ...
            <div class="g_table clearfix" id="g_addexerc_list_table">  
               ...
               <?php 
                ...
                if($n>0) { 
                    ...
                    $id = $file->id;
                    $link = "addexercise('".$id."', '".$type."', '".addslashes($file->name)."', '".$file->published."', '".$_GET['cid']."', '".JURI::root()."')";
