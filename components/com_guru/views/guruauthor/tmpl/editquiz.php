...
<div style="float:right">
	<div id="toolbar" class="btn-toolbar pull-right g_margin_right">
        <div id="toolbar-apply" class="btn-wrapper">
            <button class="btn btn-success" onclick="javascript:submitbutton2('save_quiz');">
        ...
        <div class="control-group clearfix g_row_inner">
            ...
            <div class="controls">
                <?php 
                    ...
                    $calendar = JHTML::_('calendar', $program->endpublish, 'endpublish', 'endpublish', $format, array('class'=>'inputbox', 'size'=>'25',  'maxlength'=>'19'));
                    if(substr($program->endpublish, 0, 4) == '0000' || $program->endpublish == "Never"){
                        $calendar = str_replace('value=""', 'value="'.$program->endpublish.'"', $calendar);;
                    }
                    echo $calendar;
                ?>
                &nbsp;
