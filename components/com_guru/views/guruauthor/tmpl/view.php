...
$doc->addStyleSheet(JURI::root()."components/com_guru/css/trainer_style.css");
...
if(trim($author->images) == ""){
    ...
    $guruHelper->createThumb($author->imageName, "components".DS."com_guru".DS."images", $config_author->author_image_size, $type);
...
function createAuthorLinksboots($author){
    ...
    $table = '<div class="clearfix teacher_links g_toolbar">';
    ...
    if($author->show_email==1 && trim($author->email)!=""){
        ...
        $table .= '<span class="teacher_email_guru">
					   	...
					   	<a href="mailto:'.$author->email.'">'.JText::_("GURU_EMAIL").'</a>
    ...
    if($author->show_website==1 && trim($author->website)!="http://" && trim($author->website)!=""){
        ...
        $table .= '<span class="guru_teacher_site">
					   	...
					   	<a href="'.$author->website.'" target="_blank">'.JText::_("GURU_WEBSITE").'</a>
    ...
    if($author->show_blog==1 && trim($author->blog)!="http://" && trim($author->blog)!=""){
        ...
        $table .= '<span class="guru_teacher_blog">
						...
						<a href="'.$author->blog.'" target="_blank">'.JText::_("GURU_BLOG").'</a>
    ...
    if($author->show_twitter==1 && trim($author->twitter)!=""){
        ...
        $table .= '<span class="guru_teacher_twitter">
								...
								<a href="http://www.twitter.com/'.$author->twitter.'" target="_blank">'.JText::_("GURU_TWITTER").'</a>
    ...
    if($author->show_facebook==1 && trim($author->facebook)!="http://" && trim($author->facebook)!=""){
        ...
        $table .= '<span class="guru_teacher_facebook">
					   	...
					   	<a href="'.$author->facebook.'" target="_blank">'.JText::_("GURU_FACEBOOK").'</a>
...
<div class="g_row">
	<div class="g_cell span12">
		<div>
			<div>
                <div id="teacherdetail" class="clearfix com-cont-wrap g_sect">
                <!-- Author Name -->
                <div class="<?php echo $style_author->author_name; ?> page_title">
                ...
                $row .= '<div class="teacher_row_guru" >';
                
                $row .= 	'<div class="teacher_cell_guru span12">'.$teacher_table."</div>";
                ...
                // end the display for image, description and top links (created above in $teacher_table = $return)
				...
				// start the buttom Courses by this teacher section
                        ...
                        <div class="table_container columns">
                            <table class="table table-striped">
                                    <tr class="courses_table_header g_table_header">
                                        ...
                                        <th class="g_cell_3 g_hide_mobile"><?php echo JText::_("GURU_TAB_AUTHOR_COURSES_RELEASE");?></th>
                                    </tr>
                                    <?php
				...
				// end the buttom Courses by this teacher section
