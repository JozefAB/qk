...
<form name="adminForm" action="index.php?option=com_guru&controller=guruAuthor" method="post">
<input type="button" class="btn btn-success pull-right" onclick="javascript:submitbutton()" value="<?php echo JText::_("GURU_SAVE"); ?>" size="16" />
...
<script type="text/javascript">
	...
	function submitbutton(){
		if(document.getElementById("jumptext").value==0){
			...
			document.getElementById("selstep").value=document.getElementById(sel+"F").value+"|"+<?php echo intval($_GET['button']);?>;
