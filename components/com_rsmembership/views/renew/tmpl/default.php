...
<form method="post" class="rsmembership_form" action="<?php echo JRoute::_('index.php?option=com_rsmembership&task=renewpaymentredirect'); ?>" name="membershipForm" onsubmit="return validate_subscribe();" id="rsm_renew_form">
<div class="item-page">
