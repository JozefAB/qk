...
if(!class_exists('RokMavMenuDefaultLayout')){
    ...
    ?>
        <nav id="bt-menu" class="bt-menu">
                <a href="#" class="bt-menu-trigger fa fa-bars"></a>
    <ul class = "<?php echo $this->args['class_sfx']; ?>" <?php if ($this->args['tag_id'] != null): ?>id="<?php echo $this->args['tag_id']; ?>"<?php endif; ?>>
    ...
    <?php
        ...
        {
            ?>
            <li <?php if ($item->hasListItemClasses()) : ?>class="dr-icon <?php echo $item->getListItemClasses(); ?>"<?php endif; ?> <?php if (null != $item->getCssId()): ?>id="<?php echo $item->getCssId(); ?>"<?php endif; ?>>
