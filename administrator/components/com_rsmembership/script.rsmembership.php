...
?>
		...
		<div id="installer-right">
			...
			<h2>Changelog v1.21.5</h2>
			<ul class="version-history">
				<li><span class="version-new">New</span> Support for the new Google reCAPTCHA.</li>
				<li><span class="version-upgraded">Upg</span> Re-arranged 'CAPTCHA' in the Configuration section and renamed it to 'Spam Protection'.</li>
				<li><span class="version-fixed">Fix</span> Membership Extras were not showing up correctly when adding a membership to a subscriber.</li>
				<li><span class="version-fixed">Fix</span> If reCAPTCHA (Legacy) was not configured, the error message appeared incorrectly in the frontend.</li>
			</ul>
