...
<table class="adminlist table table-striped" id="addmembershipshared">
	...
	?>
		<tr class="row<?php echo $k; ?>">
			<td><?php echo $this->item->sharedPagination->getRowOffset($i); ?></td>
			<td><?php echo JHTML::_('grid.id', $i, $row->id, false, 'cid_folders'); ?></td>
			<?php $this->ordering->showRow($saveOrder, $row->ordering, array('context' => 'membership', 'pagination' => $this->item->sharedPagination, 'listDirn' => $listDirn, 'i' => $i)); ?>
			<td align="center">
