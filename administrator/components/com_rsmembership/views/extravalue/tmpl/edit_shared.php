...
<?php if (!empty($this->item->id)) { ?>
	<div class="button2-left"><div class="blank"><a class="modal btn btn-small btn-info" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&extra_value_id='.$this->item->id.'&tmpl=component'); ?>"><?php echo JText::_('COM_RSMEMBERSHIP_ADD_CONTENT'); ?></a></div></div>
