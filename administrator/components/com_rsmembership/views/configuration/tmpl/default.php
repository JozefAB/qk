...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=configuration'); ?>" method="post" name="adminForm" id="component-form" class="form-validate form form-horizontal" enctype="multipart/form-data" autocomplete="off">
