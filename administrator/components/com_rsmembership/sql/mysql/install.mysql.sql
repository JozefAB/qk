...
CREATE TABLE IF NOT EXISTS `#__rsmembership_memberships` (
  ...
  `user_email_denied_subject` varchar(255) NOT NULL,
  ...
  `admin_email_from_addr` varchar(255) NOT NULL,
  ...
  `admin_email_denied_subject` varchar(255) NOT NULL,
  ...
  `gid_subscribe` varchar(255) NOT NULL default '18',
  `gid_expire` varchar(255) NOT NULL default '18',
