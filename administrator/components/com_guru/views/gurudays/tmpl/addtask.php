...
$medias = $this->medias;
$n = count($medias);
$node = JRequest::getVar("node","0","","int");
...
<br /><br />
<div>
<form name="form1" action="index.php?option=com_guru&controller=guruDays&task=addtask&no_html=1&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<td><?php echo JText::_("GURU_MEDIA_"); ?>:
			<select name="media_select" onChange="document.form1.submit()">
				<option value="all" <?php if ( (!isset($_POST['media_select'])) || (isset($_POST['media_select']) && $_POST['media_select'] == 'all') ) echo ' selected="selected" ';?>>all</option>
				<option value="audio" <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'audio') echo ' selected="selected" ';?>>audio</option>
				<option value="video"  <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'video') echo ' selected="selected" ';?>>video</option>
				<option value="docs" <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'docs') echo ' selected="selected" ';?>>document</option>
				<option value="url" <?php if (isset($_POST['media_select']) && $_POST['media_select'] == 'url') echo ' selected="selected" ';?>>url</option>
			</select>
		</td>
	</tr>
</table>
...
<form action="index.php?option=com_guru&controller=guruDays&task=edit&cid[]=<?php echo $_GET['cid'][0];?>" name="adminForm" method="post">
<div id="editcell">
