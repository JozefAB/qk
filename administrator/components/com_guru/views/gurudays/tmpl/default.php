 ...
 ?>	
	...
	function deleteFinalExam(course_id){
		...
		if(confirm ('<?php echo JText::_('GURU_SURE_DELETE_FINAL_EXAM'); ?>')){
			var url = 'components/com_guru/views/gurudays/tmpl/deleteFinalQuiz.php?course_id='+ course_id;
			ajaxObjects[ajaxIndex].requestFile = url;	// Specifying which file to get
	...
	function deleteScreen(group_id, screen_id, node_id)
	{
			...
			if(confirm ('<?php echo JText::_('GURU_SURE_DELETE_LESSON'); ?>')){
				var url = 'components/com_guru/views/gurudays/tmpl/deleteScreen.php?group='+ group_id +'&screen=' + screen_id;
				ajaxObjects[ajaxIndex].requestFile = url;	// Specifying which file to get
	...
	function deleteGroup(group_id, node_id)
	{
			...
			if(confirm ('<?php echo JText::_('GURU_SURE_DELETE_GROUP'); ?>')){
				var url = 'components/com_guru/views/gurudays/tmpl/deleteGroup.php?group='+ group_id ;
				ajaxObjects[ajaxIndex].requestFile = url;	// Specifying which file to get
...
<table width="100%">	
    ...
    <div class="tree tree-selectable" id="tree1">
        <ul id="dhtmlgoodies_tree2" class="tree-folder-header dhtmlgoodies_tree">
            <li style="list-style-type:none;" id="node0" noDrag="true" noSiblings="true" noDelete="true" noRename="true"><span style="margin-top: -10px; color: black; font-family:Arial,Helvetica,sans-serif; font-size:17px;"><b><?php echo $ProgramName; ?></b></span><a data-toggle="modal" data-target="#myModal" onClick = "showContent('index.php?option=com_guru&controller=guruDays&component=com_guru&task=newmodule&tmpl=component&pid=<?php echo $pid; ?> ');" style="color:#0b55c4 !important; "  href="#"><?php echo JText::_("GURU_ADD_NEW_MODULE"); ?></a><br />
                <ul>
                    ...
                    <li  style="background:url(components/com_guru/images/join_dot.png) repeat-y" isLeaf="false" LeafId="<?php echo $id; ?>" id="node<?php echo $rank; ?>">
                        ...
                        <span class="lbl"></span>
                        <a data-toggle="modal" data-target="#myModal" onClick = "showContent('<?php echo $link;?> ');" href="#">
                              <?php echo $day_title; ?>
                        </a>&nbsp;
                        ...
                        ?>
                                <script type="text/javascript">
                                    document.write('<a data-toggle="modal" data-target="#myModal" onClick = "showContent(\'index.php?option=com_guru&controller=guruTasks&task=editsbox&tmpl=component&day=<?php echo $id;?>&progrid=<?php echo intval($_GET['pid']);?>&cid[]=0 \');" href="#" ><font color="#0B55C4"><?php echo JText::_('GURU_DAY_ADD_SCREEN2'); ?></font></a>');
                                </script>
                        <?php
                            }
                            else{
                        ?>
                                <script type="text/javascript">
                                    document.write('<a data-toggle="modal" data-target="#myModal" onClick = "showContent(\'index.php?option=com_guru&controller=guruTasks&task=editsbox&tmpl=component&day=<?php echo $id;?>&progrid=<?php echo intval($_GET['pid']);?>&cid[]=\');" href="#"><font color="#0B55C4"><?php echo JText::_('GURU_DAY_ADD_SCREEN2'); ?></font></a>');
                                </script>		
                        <?php
                            }
                        ?>
