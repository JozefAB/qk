...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.floatingContainer.style.marginTop = '-100px';
		...
		this.filePathRenameItem = 'components/com_guru/views/gurudays/tmpl/folderTree_updateItem.php';
		this.filePathDeleteItem = 'components/com_guru/views/gurudays/tmpl/folderTree_updateItem.php';
		...
		*/
		...
		dropDragableNodes:function()
		{
			...
			*/
			...
			if(tmpVar=='false'){
				//var url = 'components/com_guru/views/gurudays/tmpl/saveOrderG.php?saveString1=' + saveString1+"&saveString2=" + saveString2;
				var url = 'components/com_guru/views/gurudays/tmpl/saveOrderG.php?' + for_link;
			}
			else{
				//var url = 'components/com_guru/views/gurudays/tmpl/saveOrderS.php?saveString1=' + saveString1+'&saveString2=' + saveString2;
				var url = 'components/com_guru/views/gurudays/tmpl/saveOrderS.php?' + for_link;
			}
		...
		createDropIndicator : function()
		{
			...
			this.dropTargetIndicator.style.marginTop = '-100px';
