...
<?php 
	if($page == "history1" && $p !=1){?>
        <button class="btn btn-primary pull-right" onclick="window.history.back();"><?php echo JText::_("GURU_BACK"); ?></button>
<?php 
	}
?>                    
...
?>
        <table style="width: 100%;" cellpadding="5" cellspacing="5" bgcolor="#FFFFFF">
            <tr>
                ...
                <td>
                    <?php
                        $filter_promocode = JRequest::getVar("filter_promocode", "0");
                ...
                <td>
                    <?php
                        $filter_paymentmethod = JRequest::getVar("filter_paymentmethod", "0");
                    ?>
                ...
                <td>
                    <?php
                        $filter_commission_plan = JRequest::getVar("filter_commission_plan", "0");
