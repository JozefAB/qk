				...
				<tr>
					<td align="left">
						...
						if(isset($_POST['search_promos'])) {
							echo $_POST['search_promos'];
						} elseif(isset($_SESSION['search_promos'])) {
							echo $_SESSION['search_promos'];
						}
					...
					<td align="left">
							...
							<?php 
								if(isset($_SESSION['promos_publ_status'])){
									$pb=$_SESSION['promos_publ_status'];
								}
								if(isset($_POST['promos_publ_status'])){
									$pb=$_POST['promos_publ_status'];
									$_SESSION['promos_publ_status']=$pb;
								}
								if(!isset($pb)) {$pb=NULL;}
							?>
					...
					<td>
						...
						<?php 
							if(isset($_SESSION['promo_status'])){
								$promo_sts=$_SESSION['promo_status'];
							}
							if(isset($_POST['promo_status'])){
								$promo_sts=$_POST['promo_status'];
								$_SESSION['promo_status']=$promo_sts;
							}
							if(!isset($promo_sts)) {$promo_sts=NULL;}
						?>
...
?>			
	...
	<tr class="row<?php echo $k;?>"> 
            ...
            <td>
            	<a  class="modal" rel="{handler: 'iframe', size: {x: 850, y: 500}}" href="index.php?option=com_guru&controller=guruPromos&task=show_courses&promo_id=<?php echo $promo->id;?>&tmpl=component">
                	<?php echo JText::_("GURU_APPLIED_FOR"); ?>                  
         		</a>
          	</td>
	     	...
	     	<td><?php 
				...
				?> 
	     	<td><?php if($promo->codelimit) echo $promo->codeused;?></td>		
