                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <div class="controls">
                       			<?php 
									if ($promo->id<1) $start_publish =  JText::_('GURU_TODAY');//date('Y-m-d H:i:s', time()); 
									else $start_publish =  date("".$dateformat."", strtotime($promo->codestart));
									echo JHTML::_('calendar', $start_publish, 'codestart', 'codestart', $format, array('class'=>'inputbox', 'size'=>'25',  'maxlength'=>'19')); ?>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <div class="controls">
                       			<?php 
									if(substr($promo->codeend,0,4) =='0000' || $promo->id<1) $end_publish = JText::_('GURU_NEVER'); 
									else $end_publish = date("".$dateformat."", strtotime($promo->codeend));
									echo JHTML::_('calendar', $end_publish, 'codeend', 'codeend', $format, array('class'=>'inputbox', 'size'=>'25',  'maxlength'=>'19')); ?>
