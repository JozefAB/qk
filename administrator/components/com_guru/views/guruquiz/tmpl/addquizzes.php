...
<form class="g_modal_search" name="form1" action="index.php?option=com_guru&controller=guruQuiz&task=addquizzes&no_html=1&cid[]=<?php echo $_GET['cid'][0];?>&tmpl=<?php echo JRequest::getVar("tmpl", ""); ?>" method="post">
	<table style="padding-left:2px; font-size:11px;">
       	 <td>
				<input  type="text" name="search_text"  style="height:18px; margin-bottom:0px !important;" value="<?php if(isset($_POST['search_text'])) echo $_POST['search_text'];?>" />
