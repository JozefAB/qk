...
<script language="javascript" type="text/javascript">	
	...
	function show_licences_renew(gen_number){
		...
		var url = "components/com_guru/js/ajax.php?task=setrenew&course_id="+course_id+"&gen_number="+gen_number+"&option="+option;
	...
	function setPromo(option){
		...
		var url = "components/com_guru/js/ajax.php?task=setpromo&promocode="+promo_code+"&value="+value+"&count="+n+and;
