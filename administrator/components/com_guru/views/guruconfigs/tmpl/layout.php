		...
		<?php
			...
			if($tab == "2"){
					$validation_script = 'if(document.adminForm.ctgscols.value =="cols"){
										  ...
										  else if(document.adminForm.ctgs_image_size.value == "" || document.adminForm.ctgs_image_size.value == 0){
											alert("'.JText::_("GURU_CTGS_IMAGE_SIZE_ALERT").'");
											return false;
										  }
										  ...
										  else if(document.adminForm.courses_image_size.value == "" || document.adminForm.courses_image_size.value == 0){
										  	alert("'.JText::_("GURU_COURSES_IMAGE_SIZE_ALERT").'");
											return false;
										  }
...
<?php
	...
	if(isset($list_categories) && count($list_categories) > 0){		
		...
		$ctgs_image_size = $list_categories->ctgs_image_size;
		$ctgs_image_size_type = $list_categories->ctgs_image_size_type;
		$ctgs_image_alignment = $list_categories->ctgs_image_alignment;
		$ctgs_wrap_image = $list_categories->ctgs_wrap_image;
	...
	if(isset($category) && count($category) > 0){		
		...
		$ctg_wrap_image = $category->ctg_wrap_image;
...
<!-- ------------------------------- List of categories ------------------------------- -->
 <div class="row-fluid">
     <ul class="nav nav-tabs">
            <li class="active"><a href="#Lcat" data-toggle="tab"><?php echo JText::_('GURU_LIST_CATEGORIES');?></a></li>
            <li><a href="#cat_page" data-toggle="tab"><?php echo JText::_('GURU_CATEGORY_PAGE');?></a></li>
            <li><a href="#list_courses" data-toggle="tab"><?php echo JText::_('GURU_LIST_COURSES');?></a></li>
            <li><a href="#course_page" data-toggle="tab"><?php echo JText::_('GURU_COURSE_PAGE');?></a></li>
            <li><a href="#list_auth" data-toggle="tab"><?php echo JText::_('GURU_LIST_AUTHORS');?></a></li>
            <li><a href="#auth_page" data-toggle="tab"><?php echo JText::_('GURU_AUTHOR_PAGE');?></a></li>
     </ul>
     <div class="tab-content">
        <div class="tab-pane active" id="Lcat">
            ...
            <div class="span12"> 
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="control-group">
                                <label class="control-label" for="image"><?php echo JText::_('JAS_IMGSIZE');?><span style="color:#FF0000">*</span></label>
                            <div class="controls">
                            	<div class="pull-left">
                       				<input style="width:83%" type="text" id="ctgs_image_size" name="ctgs_image_size" value="<?php echo $ctgs_image_size; ?>" />
                                </div>
                                <div class="pull-left">
                                    <select  style="margin-left:15px;" id="ctgs_image_size_type" name="ctgs_image_size_type">
                                        <option value="0" <?php if($ctgs_image_size_type == "0"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_WIDE"); ?></option>
                                        <option value="1" <?php if($ctgs_image_size_type == "1"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_HEIGHT"); ?></option>				
                                    </select>
                                    <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_CATEGORIES_IMGSIZE"); ?>" >
                                        <img border="0" src="components/com_guru/images/icons/tooltip.png">
                                    </span>
                                </div>
                   			</div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                       			<select id="ctgs_image_alignment" name="ctgs_image_alignment">
                                    <option value="0" <?php if($ctgs_image_alignment == "0"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_LEFT"); ?></option>
                                    <option value="1" <?php if($ctgs_image_alignment == "1"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_RIGHT"); ?></option>
                                </select>
            ...
            <div class="span12"> 
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="control-group">
                                <label class="control-label" for="img_align"><?php echo JText::_('GURU_WRAP_IMAGE');?>		
               				  </label>
                              <div class="controls">
                       			<input type="hidden" name="ctgs_wrap_image" value="1">
								<?php
									$checked = '';
									if($ctgs_wrap_image == 0){
										$checked = 'checked="checked"';
									}
								?>
								<input type="checkbox" <?php echo $checked; ?> value="0" class="ace-switch ace-switch-5" name="ctgs_wrap_image">
								<span class="lbl"></span>
								
                                <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_CATEGORIES_WRAP_IMAGE"); ?>" >
                                    <img border="0" src="components/com_guru/images/icons/tooltip.png">
                                </span>
                   			</div>
                            </div>										
        ...
        <div class="tab-pane" id="cat_page">
       		<div class="row-fluid">
            <div class="span12"> 
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="span12">
                            <div class="row-fluid">
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <select id="ctg_image_alignment" name="ctg_image_alignment">
                                        <option value="0" <?php if($ctg_image_alignment == "0"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_LEFT"); ?></option>
                                        <option value="1" <?php if($ctg_image_alignment == "1"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_RIGHT"); ?></option>
                                    </select>
                    ...
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="hidden" name="ctg_wrap_image" value="1">
								<?php
									$checked = '';
									if($ctg_wrap_image == 0){
										$checked = 'checked="checked"';
								...
								?>
								<input type="checkbox" <?php echo $checked; ?> value="0" class="ace-switch ace-switch-5" name="ctg_wrap_image">
								<span class="lbl"></span>
								
                                <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_CATEGORY_WRAP_IMAGE"); ?>" >
                                    <img border="0" src="components/com_guru/images/icons/tooltip.png">
                                </span>
                               </div>
                            </div>
        ...
        <div class="tab-pane" id="list_courses">
        <div class="row-fluid">
            <div class="span12"> 
                <div class="row-fluid">
                    <div class="span12">
       ...
       <div class="row-fluid">
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                       			<select id="courses_image_alignment" name="courses_image_alignment">
                                    <option value="0" <?php if($courses_image_alignment == "0"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_LEFT"); ?></option>
                                    <option value="1" <?php if($courses_image_alignment == "1"){echo 'selected="selected"'; } ?>><?php echo JText::_("GURU_RIGHT"); ?></option>
                                </select>
        ...
        <div class="row-fluid">
            ...
            <div class="tab-pane" id="course_page">	
            	<div class="well">
    ...
    <div class="row-fluid">
        <div class="span12"> 
            ...
            <div class="tab-pane" id="list_auth">
            	 <div class="row-fluid">
        <div class="span12"> 
            <div class="row-fluid">
                <div class="span12">
    ...
    <div class="row-fluid">
     ...
     <div class="row-fluid">
        <div class="span12"> 
            ...
            <div class="tab-pane" id="auth_page">
            	 <div class="row-fluid">
            <div class="span12"> 
                <div class="row-fluid">
                    <div class="span12">
