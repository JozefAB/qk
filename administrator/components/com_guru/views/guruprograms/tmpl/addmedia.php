...
<br /><br />
<div>
    <form name="form1" action="index.php?option=com_guru&controller=guruPrograms&task=addmedia&tmpl=component&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
    ...
    <div id="editcell">
        <table class="table table-striped">
            ...
            if($n>0) { 
                ...
                $link = "addmedia('".$id."', '".$type."', '".addslashes($file->name)."', '".$file->published."', '".$_GET['cid'][0]."', '".JURI::root()."')";
