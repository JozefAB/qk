...
?>
		<tr class="row<?php echo $k;?>"> 
			...
			<a rel="{handler: 'iframe', size: {x: 850, y: 600}}" href="<?php echo JRoute::_("index.php?option=com_guru&controller=guruQuiz&task=listQuizStud&cid=".intval($id)."&pid=".$pid."&tmpl=component"); ?>" class="modal"><?php echo JText::_('GURU_VIEW_QUIZZES_RESULTS')."(".$count_quizz_taken.")";?></a>
			<?php 
			}
			else{
			}
