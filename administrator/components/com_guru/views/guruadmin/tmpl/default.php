...
$document->addScript(JURI::root()."administrator/components/com_guru/js/jquery.js");
$document->addScript(JURI::root()."administrator/components/com_guru/js/jquery.flot.js");
$document->addScript(JURI::root()."administrator/components/com_guru/js/jquery.flot.time.js"); 
include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."helpers".DS."amcharts".DS."daily_chart.php");
        ...
        <div class="span3">
			...
			<?php
                    foreach($bsc as $key=>$value){
						...
						$author_name = "SELECT name FROM #__users WHERE id IN( SELECT author FROM #__guru_program WHERE id='".intval($value['idc'])."')";
						...
						echo '<tr>
								<td>
									 ...
									 '.JText::_("GURU_BY").' '.' <a href="index.php?option=com_guru&controller=guruAuthor&task=edit&id='.intval(@$author_id["0"]).'">'.@$author_name["0"].'</a>
								</td>
