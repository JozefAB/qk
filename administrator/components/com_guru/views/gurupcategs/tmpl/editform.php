...
?>
	...
	function deleteImage(id){
		var url = 'components/com_guru/views/gurupcategs/tmpl/ajax.php?id='+id;
...
<div>
 <form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" >
	...
	<div class="well"><?php echo ($categ->id > 0)?JText::_('GURU_EDITCATEGORY'):JText::_('GURU_NEWCATEGORY'); ?></div>     
