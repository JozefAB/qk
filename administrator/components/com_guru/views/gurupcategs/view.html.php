...
class guruAdminViewguruPcategs extends JViewLegacy {
	...
	*/
	...
	function editForm($tpl = null) {
		...
		//get post params
		if (isset($_POST['name'])) $categ->name = $_POST['name'];
		if (isset($_POST['description'])) $categ->description = $_POST['description'];
		if (isset($_POST['parentcategory_id'])) $categ->name = $_POST['name'];
		//get post params
