...
function changeType(value){
	switch(value){
		case 'video':
			document.getElementById('videoblock').style.display="table-row";
			...
			document.getElementById('auto_play').style.display="table-row";
			break;
		case 'audio':
			document.getElementById('videoblock').style.display="none";
			document.getElementById('audioblock').style.display="table-row";
			document.getElementById('docsblock').style.display="none";
			document.getElementById('urlblock').style.display="none";
			document.getElementById('imageblock').style.display="none";
			document.getElementById('textblock').style.display="none";
		...
		case 'docs':
			document.getElementById('videoblock').style.display="none";
			document.getElementById('audioblock').style.display="none";
			document.getElementById('docsblock').style.display="table-row";
			document.getElementById('urlblock').style.display="none";
			document.getElementById('imageblock').style.display="none";
			document.getElementById('textblock').style.display="none";
			document.getElementById('fileblock').style.display="none";
		...
		case 'url':
			...
			document.getElementById('audioblock').style.display="none";
			document.getElementById('docsblock').style.display="none";
			document.getElementById('urlblock').style.display="table-row";
			document.getElementById('imageblock').style.display="none";
			document.getElementById('textblock').style.display="none";
			document.getElementById('fileblock').style.display="none";
			document.getElementById('auto_play').style.display="none";
		...
		case 'Article':
			...
			document.getElementById('fileblock').style.display="none";
			document.getElementById('auto_play').style.display="none";
			document.getElementById('artblock').style.display="table-row";
			break;
		case 'image':
			document.getElementById('videoblock').style.display="none";
			document.getElementById('audioblock').style.display="none";
			document.getElementById('docsblock').style.display="none";
			document.getElementById('urlblock').style.display="none";
			document.getElementById('imageblock').style.display="table-row";
			document.getElementById('textblock').style.display="none";
			document.getElementById('fileblock').style.display="none";
			document.getElementById('auto_play').style.display="none";
			document.getElementById('artblock').style.display="none";
		...
		case 'text':
			...
			document.getElementById('urlblock').style.display="none";
			document.getElementById('imageblock').style.display="none";
			document.getElementById('textblock').style.display="table-row";
			document.getElementById('fileblock').style.display="none";
			document.getElementById('auto_play').style.display="none";
			document.getElementById('artblock').style.display="none";
			break;
		case 'file':
			...
			document.getElementById('imageblock').style.display="none";
			document.getElementById('textblock').style.display="none";
			document.getElementById('fileblock').style.display="table-row";
			document.getElementById('auto_play').style.display="none";
			document.getElementById('artblock').style.display="none";
			break;
		}
...
function listMassVideos(site){
	...
	var req = new Request.HTML({
		method: 'get',
		url: site+'index.php?option=com_guru&controller=guruMedia&task=ajax_add_mass_video&list='+list+'&host='+host+'&page='+page+'&start_with='+start_with+'&per_page='+per_page+'&tmpl=component',
		data: { 'do' : '1' },
		onComplete: function(response){
