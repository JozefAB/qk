...
defined( '_JEXEC' ) or die( 'Restricted access' );
 ...
 <div class="container-fluid">
    ...
    <div class="well well-minimized">
		<?php echo JText::_("GURU_LANGUAGE_SETTINGS_DESCRIPTION1").'<a target="_blank" href="https://www.transifex.com/projects/p/iguru/">'.JText::_("GURU_LANGUAGE_SETTINGS_DESCRIPTION2").'</a>'.JText::_("GURU_LANGUAGE_SETTINGS_DESCRIPTION3"); ?>
	</div>       
