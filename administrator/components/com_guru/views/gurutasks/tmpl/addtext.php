...
function addmedia (idu, name, asoc_file, description, isquiz, the_real_quiz_id) {
    loadprototipe();
	var url = 'components/com_guru/views/gurutasks/tmpl/ajaxAddText.php?id='+idu;
...
<br /><br />
<div>
<form name="form1" action="index.php?option=com_guru&controller=guruTasks&task=addtext&txt=<?php echo $_GET['txt'];?>&tmpl=component&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
...
<form name="adminForm" action="index.php?option=com_guru&controller=guruTasks&task=addtext&txt=<?php echo $_GET['txt'];?>&tmpl=component&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
