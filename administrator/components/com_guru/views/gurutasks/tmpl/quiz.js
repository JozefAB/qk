		...
		if(the_answer == the_right_answer)
			{
				...
				secondcolumn = '<img src="<?php echo JURI::base().DS."components".DS."com_guru".DS."images".DS."wright.png" ;?>">  '+ the_answer;
			}	
		else
			{
				the_answer=the_answer.split("$$$$$").join("'");
				the_right_answer=the_right_answer.split("$$$$$").join("'");
				secondcolumn = '<img src="<?php echo JURI::base().DS."components".DS."com_guru".DS."images".DS."wrong.png" ;?>">  ' + the_right_answer + '  (Your answer: ' + the_answer + ')';	
			}	
