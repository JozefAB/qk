...
class guruAdminViewguruDtree extends JViewLegacy {
	...
	function showDtree($tpl = null){	
		$installer = JRequest::getVar("installer", "0");
		if($installer == 1){
	...
	function installDefaultValues(){
		include_once(JPATH_SITE.DS.'administrator'.DS.'components'.DS.'com_guru'.DS.'helpers'.DS.'install.guru.php');
		$install_content = new com_guruInstallerScript();
