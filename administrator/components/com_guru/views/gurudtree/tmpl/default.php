...
<script type="text/javascript">
	<?php
		...
		if($controller != ""){
	?>
			document.write("<script src='components/com_guru/js/jquery-1.9.1.min.js'>"+"<"+"/script>");
	<?php
		}
	?>
	document.write("<script src='<?php echo JURI::root(); ?>components/com_guru/js/1jqueryui.js'>"+"<"+"/script>");
</script>
