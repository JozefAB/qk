...
require_once ( JPATH_BASE .DS.'libraries'.DS.'joomla'.DS.'object'.DS.'object.php');
require_once ( JPATH_BASE .DS.'libraries'.DS.'joomla'.DS.'database'.DS.'database.php');
//require_once ( JPATH_BASE .DS.'libraries'.DS.'joomla'.DS.'database'.DS.'query'.DS.'mysql.php');
